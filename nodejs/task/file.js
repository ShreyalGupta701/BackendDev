...
// const fs =require("fs");
// fs.writeFileSync('./explale.txt',"hello world");
// const result=fs.readFileSync("./explale.txt", "utf-8");
// console.log(result);

// // callback function 
// fs.readFile("./explale.txt", "utf-8" ,(err,result)=>
// {
//     if(err){
...
// fs.appendFile("./explale.txt",`${Date.now()} hey there `);
